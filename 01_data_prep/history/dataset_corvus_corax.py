...
#---------------------------
# Europe
xc = xco.XCO(start_path = 'd:/xc_real_projects/xc_corvus_corax')
# Create a template json parameter file (to be edited)
# xc.make_param(filename = 'download_corvus_corax.json', template = "corvidae")
# Get information of what will be downloaded
# xc.download_summary(download_params = 'download_corvus_corax_adjusted.json', verbose = True) 
...
xc.extract_spectrograms(fs_tag = 24000, segm_duration = 0.394 , segm_step = 0.80, win_siz = 256, win_olap = 220.5, 
                        max_segm_per_file = 16, equalize = True, colormap='viridis', verbose = True)
#---------------------------
