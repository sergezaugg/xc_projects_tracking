...
xc2 = xco.XCO(start_path = "D:/xc_real_projects/xc_data_02_Corvidae")

# to have approx 2000 files with all possible Corvidae
xc2.download_summary(fam = "Corvidae", smp_min = 24000, smp_max = 48000, q = "A", len_min = 10, len_max = 30, verbose=True)
